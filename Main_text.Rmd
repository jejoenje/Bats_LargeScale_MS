...
lme4_version <- as.vector(unlist(sessionInfo()[[6]]$lme4[2]))
...
One measure of ground level wind speed **anenometer make** was taken at the end of each section (i.e in each distance band) on each survey visit, and minimum daily average temperature measures for each survey visit were obtained from the UK MIDAS weather station data at Grangemouth (**coordinates**) **REF**.
